...
os.system("clear")
print("Choose the below options from the table created")
print('\n')

print(" 1. Nmap Port Scanning ")
print(" 2. NetworkSniffer ")
print(" 3. Password cracking using john ")
print(" 4. Get Email/Phone/Banner")
print(" 5. Vunerability Scanner")
print(" 6. Check Running Service ")
